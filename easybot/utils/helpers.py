...
_TOOL_RESULTS_DIR = ".easybot/tool-results"
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("easybot") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
    ...
    try:
        from easybot.utils.gitstore import GitStore
