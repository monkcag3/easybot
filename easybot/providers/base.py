...
class LLMResponse:
    ...
    # Structured error metadata used by retry pl=olicy when finished_reason == "error"
...
class LLMProvider(ABC):
    ...
    @classmethod
    def _tool_cache_marker_indices(
        cls,
    ...
    @classmethod
    def _is_retryable_429_response(
        cls,
        response: LLMResponse,
    ) -> bool:
    ...
    async def chat_stream(
        ...
        Return the same ``LLMResponse`` as :meth:`chat`. The default
